...
# =========================
st.set_page_config(
    page_title="Deteksi Sentimen Tweet (BiLSTM)",
    page_icon="🧠",
    layout="centered",
)
...
# Artifact standard names from training script
...
st.markdown(
    '<div class="subtitle">Demo lokal model Deep Learning dari artifact standar training</div>',
    unsafe_allow_html=True,
)
...
with st.expander("Info Artifact Model", expanded=False):
    st.json(
        {
...
st.divider()
st.caption("NLP Project — Deep Learning BiLSTM (Local Streamlit App)")
